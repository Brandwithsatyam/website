      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto font-light leading-relaxed relative z-10">
            With years of experience in video editing and visual content strategy, I
        ...
        <CTASection
          ...
          description="Let's discuss your video editing and strategy needs and create something amazing together. I'm here to help bring your vision to life with professional quality and creative flair."
